...
import { getDefaultIntegrationsWithoutPerformance, SDK_VERSION, init as init$1, withScope, captureMessage, continueTrace, startSpanManual, getCurrentScope, captureException, flush } from '@sentry/node';
...
import { awsLambdaIntegration } from './integration/awslambda.js';
import { markEventUnhandled } from './utils.js';
